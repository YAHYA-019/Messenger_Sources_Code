...
public interface NativeMap {
    ...
    long[] addMarkers(List list);

    long addPolygon(Polygon polygon);

    long[] addPolygons(List list);

    long addPolyline(Polyline polyline);

    long[] addPolylines(List list);
    ...
    List queryRenderedFeatures(PointF pointF, String[] strArr, Expression expression);

    List queryRenderedFeatures(RectF rectF, String[] strArr, Expression expression);
