...
/* loaded from: QPLSearchNullStateLatencyLoggingJni.class */
public final class QPLSearchNullStateLatencyLoggingJni {
    public static final BS6 Companion = new Object();
    public HybridData mHybridData = initHybrid();

    /* JADX WARN: Type inference failed for: r0v0, types: [X.BS6, java.lang.Object] */
    static {
        C0il.A0B("search-qplloggernullstate");
    }
