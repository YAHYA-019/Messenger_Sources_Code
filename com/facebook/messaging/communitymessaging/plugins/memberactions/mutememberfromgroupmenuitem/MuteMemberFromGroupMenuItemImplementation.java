...
/* loaded from: MuteMemberFromGroupMenuItemImplementation.class */
public final class MuteMemberFromGroupMenuItemImplementation {
    public static final /* synthetic */ C06z[] A0A = {new 0Fy(MuteMemberFromGroupMenuItemImplementation.class, "communityId", "getCommunityId()J", 0)};
    public long A00;
    public Long A01;
    ...
    public MuteMemberFromGroupMenuItemImplementation(Context context, 06Z r303, 1Iw r304, Bs5 bs5, DJY djy, MigColorScheme migColorScheme, User user) {
    ...
    public final C1rh A00() {
        ...
        C1rh A00 = B0x.A00(2MQ.A0L, C1u3.A0b, r0, 7zO.A0U(new DD4(this, 31)), this.A09, context.getString(i));
        11T.A0A(A00);
        return A00;
    }
}
