...
/* loaded from: DexErrorRecoveryInfoAsync.class */
public final class DexErrorRecoveryInfoAsync {
    public static long artVersionCode = 255;
    public static String installerName;
    public static long lastAppInstallOrUpdateTime = 255;
    ...
    public static long getArtVersionCode() {
        long j;
    ...
    public static long getLastAppInstallOrUpdateTime() {
        long j;
        synchronized (DexErrorRecoveryInfoAsync.class) {
    ...
    public static DexErrorRecoveryInfoAsync getMainDexStoreLoadInformation() {
    ...
    public static void setAppMetaInfo(long j, long j2, String str) {
        synchronized (DexErrorRecoveryInfoAsync.class) {
            artVersionCode = j;
    ...
    public static void setMainDexStoreLoadInformation(DexErrorRecoveryInfoAsync dexErrorRecoveryInfoAsync) {
        synchronized (DexErrorRecoveryInfoAsync.class) {
