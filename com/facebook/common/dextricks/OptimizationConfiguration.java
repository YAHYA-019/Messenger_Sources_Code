...
/* loaded from: OptimizationConfiguration.class */
public final class OptimizationConfiguration {
    ...
    /* loaded from: OptimizationConfiguration$Builder.class */
    ...
    /* loaded from: OptimizationConfiguration$Provider.class */
    ...
    public OptimizationConfiguration(Prio prio, int i, int i2, int i3, int i4, int i5, int i6, long j, boolean z) {
        this.prio = prio;
        this.flags = i;
