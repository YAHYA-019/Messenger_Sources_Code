...
public class ActionId {
    ...
    public static String getActionName(int i) {
        switch (i) {
            ...
            case RETRY_AFTER_FAILURE /* 52 */:
                return "RETRY_AFTER_FAILURE";
            case RETRY_AFTER_RECONNECT /* 53 */:
                return "RETRY_AFTER_RECONNECT";
            case QUEUEING_BEGIN /* 54 */:
                return "QUEUEING_BEGIN";
            case QUEUEING_SUCCESS /* 55 */:
                return "QUEUEING_SUCCESS";
            case QUEUEING_FAIL /* 56 */:
                return "QUEUEING_FAIL";
            case MESSAGE_UPDATE_START /* 57 */:
                return "MESSAGE_UPDATE_START";
            case MESSAGE_UPDATE_END /* 58 */:
                return "MESSAGE_UPDATE_END";
            case PHOTO_CAPTURED /* 59 */:
                return "PHOTO_CAPTURED";
            case MEDIA_PREVIEW_VISIBLE /* 60 */:
                return "MEDIA_PREVIEW_VISIBLE";
            case COUNTER /* 61 */:
                return "COUNTER";
            case INTERACTION_LOAD_TIMELINE_HEADER /* 62 */:
                return "INTERACTION_LOAD_TIMELINE_HEADER";
            case 63:
                return "INTERACTION_LOAD_EVENT_PERMALINK";
            case 64:
                return "INTERACTION_LOAD_GROUPS_FEED";
            case INTERACTION_LOAD_PAGE_HEADER /* 65 */:
                return "INTERACTION_LOAD_PAGE_HEADER";
            case INTERACTION_LOAD_PAGE_HEADER_ADMIN /* 66 */:
                return "INTERACTION_LOAD_PAGE_HEADER_ADMIN";
            case INTERACTION_LOAD_PERMALINK /* 67 */:
                return "INTERACTION_LOAD_PERMALINK";
            case INTERACTION_OPEN_COMPOSER /* 68 */:
                return "INTERACTION_OPEN_COMPOSER";
            case INTERACTION_OPEN_MEDIA_PICKER /* 69 */:
                return "INTERACTION_OPEN_MEDIA_PICKER";
            case INTERACTION_OPEN_PHOTO_GALLERY /* 70 */:
                return "INTERACTION_OPEN_PHOTO_GALLERY";
            case INTERACTION_OPEN_CHECK_IN /* 71 */:
                return "INTERACTION_OPEN_CHECK_IN";
            case INTERACTION_LOAD_WEB_VIEW /* 72 */:
                return "INTERACTION_LOAD_WEB_VIEW";
            case INTENT_MAPPED /* 73 */:
                return "INTENT_MAPPED";
            case ACTIVITY_LAUNCHED /* 74 */:
                return "ACTIVITY_LAUNCHED";
            case ACTIVITY_PAUSED /* 75 */:
                return "ACTIVITY_PAUSED";
            case ACTIVITY_STARTED /* 76 */:
                return "ACTIVITY_STARTED";
            case ACTIVITY_RESUMED /* 77 */:
                return "ACTIVITY_RESUMED";
            case FRAGMENT_CREATED /* 78 */:
                return "FRAGMENT_CREATED";
            case FRAGMENT_RESUMED /* 79 */:
                return "FRAGMENT_RESUMED";
            case 80:
                return "ACTIVITY_ON_CREATE";
            case INTENT_MAPPING_BEGIN /* 81 */:
                return "INTENT_MAPPING_BEGIN";
            case FRAGMENT_ON_CREATE /* 82 */:
                return "FRAGMENT_ON_CREATE";
            case FRAGMENT_NEW_INSTANCE /* 83 */:
                return "FRAGMENT_NEW_INSTANCE";
            case MARKER_SWAPPED /* 84 */:
                return "MARKER_SWAPPED";
            case FRAGMENT_INSTANCE_CREATED /* 85 */:
                return "FRAGMENT_INSTANCE_CREATED";
            case PREV_ACTIVITY_PAUSED /* 86 */:
                return "PREV_ACTIVITY_PAUSED";
            case ERROR /* 87 */:
                return "ERROR";
            case METHOD_INVOKE /* 88 */:
                return "METHOD_INVOKE";
            case FINALLY /* 89 */:
                return "FINALLY";
            case PHOTO_DOWNLOAD_COMPLETE /* 90 */:
                return "PHOTO_DOWNLOAD_COMPLETE";
            case MINIPREVIEW_COMPLETE /* 91 */:
                return "MINIPREVIEW_COMPLETE";
            case SEARCH_TYPEAHEAD /* 92 */:
                return "SEARCH_TYPEAHEAD";
            case ANIMATION_END /* 93 */:
                return "ANIMATION_END";
            case UDP_REQUEST_SEND /* 94 */:
                return "UDP_REQUEST_SEND";
            case MAIN_COMPLETE /* 95 */:
                return "MAIN_COMPLETE";
            case INTERRUPTED /* 96 */:
                return "INTERRUPTED";
            case NETWORK_FAILED /* 97 */:
                return "NETWORK_FAILED";
            case NETWORK_RESPONSE /* 98 */:
                return "NETWORK_RESPONSE";
            case EDGE_PROCESSING_BEGIN /* 99 */:
                return "EDGE_PROCESSING_BEGIN";
            case 100:
                return "NEWSFEED_PROCESS_RESPONSE";
            case ON_VIEW_CREATED_END /* 101 */:
                return "ON_VIEW_CREATED_END";
            case DATA_LOAD_START /* 102 */:
                return "DATA_LOAD_START";
            case LEGACY_MARKER /* 103 */:
                return "LEGACY_MARKER";
            case ACTION_BAR_COMPLETE /* 104 */:
                return "ACTION_BAR_COMPLETE";
            case ABORTED /* 105 */:
                return "ABORTED";
            case QUERY_READY /* 106 */:
                return "QUERY_READY";
            case RTMP_PACKET_RECEIVED /* 107 */:
                return "RTMP_PACKET_RECEIVED";
            case 108:
                return "REQUESTED_PLAYING";
            case RTMP_CONNECTION_REQUESTED /* 109 */:
                return "RTMP_CONNECTION_REQUESTED";
            case RTMP_CONNECTION_RELEASE /* 110 */:
                return "RTMP_CONNECTION_RELEASE";
            case NEW_START_FOUND /* 111 */:
                return "NEW_START_FOUND";
            case MISSED_EVENT /* 112 */:
                return "MISSED_EVENT";
            case TIMEOUT /* 113 */:
                return "TIMEOUT";
            case CONTROLLER_INITIATED /* 114 */:
                return "CONTROLLER_INITIATED";
            case RTMP_STREAM_PREPARED /* 115 */:
                return "RTMP_STREAM_PREPARED";
            case VIDEO_PLAYING /* 116 */:
                return "VIDEO_PLAYING";
            case RTMP_CONNECTION_CONNECTED /* 117 */:
                return "RTMP_CONNECTION_CONNECTED";
            case RTMP_CONNECTION_FAILED /* 118 */:
                return "RTMP_CONNECTION_FAILED";
            case RTMP_CONNECTION_INTERCEPTED /* 119 */:
                return "RTMP_CONNECTION_INTERCEPTED";
            case VIDEO_SET_RENDERER_CONTEXT /* 120 */:
                return "VIDEO_SET_RENDERER_CONTEXT";
            case HEADER_DATA_LOADED /* 121 */:
                return "HEADER_DATA_LOADED";
            case CARD_DATA_LOADED /* 122 */:
                return "CARD_DATA_LOADED";
            case VIEW_WILL_APPEAR_BEGIN /* 123 */:
                return "VIEW_WILL_APPEAR_BEGIN";
            case VIEW_DID_LOAD_BEGIN /* 124 */:
                return "VIEW_DID_LOAD_BEGIN";
            case 125:
                return "COMPONENTS_DATA_SOURCE_WILL_BEGIN_UPDATES";
            case COMPONENTS_DATA_SOURCE_DID_END_UPDATES /* 126 */:
                return "COMPONENTS_DATA_SOURCE_DID_END_UPDATES";
            case 127:
                return "LOAD_VIEW_BEGIN";
            case 128:
                return "RTMP_FIRST_KEY_FRAME_RECEIVED";
            case MESSENGER_QUEUE_CREATION /* 129 */:
                return "MESSENGER_QUEUE_CREATION";
            case APP_DID_FINISH_LAUNCHING /* 130 */:
                return "APP_DID_FINISH_LAUNCHING";
            case APP_DID_BECOME_ACTIVE /* 131 */:
                return "APP_DID_BECOME_ACTIVE";
            case APP_WILL_ENTER_FOREGROUND /* 132 */:
                return "APP_WILL_ENTER_FOREGROUND";
            case APP_DID_ENTER_BACKGROUND /* 133 */:
                return "APP_DID_ENTER_BACKGROUND";
            case APP_MAIN /* 134 */:
                return "APP_MAIN";
            case MQTT_CONNECTING /* 135 */:
                return "MQTT_CONNECTING";
            case MQTT_CONNECTED /* 136 */:
                return "MQTT_CONNECTED";
            case MQTT_DISCONNECTED /* 137 */:
                return "MQTT_DISCONNECTED";
            case MESSENGER_DELTA_REQUEST /* 138 */:
                return "MESSENGER_DELTA_REQUEST";
            case APP_FIRST_VIEW_CONTROLLER /* 139 */:
                return "APP_FIRST_VIEW_CONTROLLER";
            case MESSENGER_THREAD_LIST_LOADED /* 140 */:
                return "MESSENGER_THREAD_LIST_LOADED";
            case MESSENGER_THREAD_LIST_DISPLAYED /* 141 */:
                return "MESSENGER_THREAD_LIST_DISPLAYED";
            case PREV_ACTIVITY_PAUSE /* 142 */:
                return "PREV_ACTIVITY_PAUSE";
            case ACTIVITY_RESUME /* 143 */:
                return "ACTIVITY_RESUME";
            case ACTIVITY_START /* 144 */:
                return "ACTIVITY_START";
            case BEGIN_START_ACTIVITY /* 145 */:
                return "BEGIN_START_ACTIVITY";
            case END_START_ACTIVITY /* 146 */:
                return "END_START_ACTIVITY";
            case FILE_SYSTEM_FAIL /* 147 */:
                return "FILE_SYSTEM_FAIL";
            case FORMAT_ERROR /* 148 */:
                return "FORMAT_ERROR";
            case PRIVACY_VIOLATION /* 149 */:
                return "PRIVACY_VIOLATION";
            case 150:
                return "NETWORK_RESPONSE_INITIAL_SCAN";
            case POPULATE_CONSISTENCY_MEMORY_CACHE /* 151 */:
                return "POPULATE_CONSISTENCY_MEMORY_CACHE";
            case APPLY_OPTIMISTICS /* 152 */:
                return "APPLY_OPTIMISTICS";
            case APPLY_FINISHED_LIST /* 153 */:
                return "APPLY_FINISHED_LIST";
            case APPLY_FINISHED_LIST_AGAIN /* 154 */:
                return "APPLY_FINISHED_LIST_AGAIN";
            case FUTURE_LISTENERS_COMPLETE /* 155 */:
                return "FUTURE_LISTENERS_COMPLETE";
            case SERVICE_ON_START_COMMAND /* 156 */:
                return "SERVICE_ON_START_COMMAND";
            case WAIT_FOR_BLOCKERS /* 157 */:
                return "WAIT_FOR_BLOCKERS";
            case NOTIFY_SUBSCRIBERS /* 158 */:
                return "NOTIFY_SUBSCRIBERS";
            case FAIL_FILE_TOO_LARGE /* 159 */:
                return "FAIL_FILE_TOO_LARGE";
            case OFFLINE /* 160 */:
                return "OFFLINE";
            case ASNYC_FAILED /* 161 */:
                return "ASNYC_FAILED";
            case ASYNC_FAIL /* 162 */:
                return "ASYNC_FAIL";
            case ON_ATTACH_FRAGMENT /* 163 */:
                return "ON_ATTACH_FRAGMENT";
            case VIEW_DID_APPEAR_BEGIN /* 164 */:
                return "VIEW_DID_APPEAR_BEGIN";
            case DISPLAYED /* 165 */:
                return "DISPLAYED";
            case DISPLAYED_ON_SCREEN /* 166 */:
                return "DISPLAYED_ON_SCREEN";
            case ASYNC_ACTION_SUCCESS /* 167 */:
                return "ASYNC_ACTION_SUCCESS";
            case ASYNC_ACTION_FAIL /* 168 */:
                return "ASYNC_ACTION_FAIL";
            case CONNECTIVITY_CHANGED /* 169 */:
                return "CONNECTIVITY_CHANGED";
            case VIDEO_DISPLAYED /* 170 */:
                return "VIDEO_DISPLAYED";
            case VIDEO_REQUESTED_PLAYING /* 171 */:
