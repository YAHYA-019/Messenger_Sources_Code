...
/* loaded from: FFSingletonJNILogger.class */
public class FFSingletonJNILogger {

    /* loaded from: FFSingletonJNILogger$CollectionControlDecision.class */
    ...
    /* loaded from: FFSingletonJNILogger$CollectionControlDecisionStatus.class */
    public enum CollectionControlDecisionStatus {
        ...
        public static CollectionControlDecisionStatus fromVal(int i) {
            return i != 1 ? i != 2 ? SUCCESS : EVENT_CONFIG_NOT_SET : IDENTITY_UNAVAILABLE;
        }
    }

    static {
        C0il.A0B("ffsingletonjnilogger");
    }
