...
/* loaded from: RetinaConfig.class */
public class RetinaConfig {
    ...
    /* loaded from: RetinaConfig$Builder.class */
    ...
    public RetinaConfig(String str, String str2, String str3, String str4, long j, long j2, long j3, long j4, boolean z, boolean z2, boolean z3, boolean z4) {
        this.interProbeDelayUs = j;
        this.testDirection = str4;
        this.numberOfProbes = j2;
        this.numberOfTests = j3;
        this.probeSizeBytes = j4;
        this.profileName = str;
        this.useProfile = z4;
        this.retinaServers = str3;
        this.onlyConnected = z3;
        this.enableCustomProbeSizes = z2;
        this.dnsResolutionEnabled = z;
        this.retinaServerFallbackDomain = str2;
    }
