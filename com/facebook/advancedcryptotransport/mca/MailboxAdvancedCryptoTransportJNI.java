package com.facebook.advancedcryptotransport.mca;

import X.C0il;
import java.util.List;

/* loaded from: MailboxAdvancedCryptoTransportJNI.class */
public class MailboxAdvancedCryptoTransportJNI {
    static {
        C0il.A0B("mailboxadvancedcryptotransportjni");
    }
    ...
    public static final native Object dispatchCqlOIIJOOZ(int i, int i2, int i3, long j, Object obj, Object obj2, boolean z);

    public static final native Object dispatchCqlOIJJOOZZ(int i, int i2, long j, long j2, Object obj, Object obj2, boolean z, boolean z2);
