...
public abstract class zzj extends zzz {
    ...
    public zzj(byte[] bArr) {
        int A03 = 0FI.A03(-61322954);
        AbstractC00481b7.A07(bArr.length == 25);
        this.A00 = Arrays.hashCode(bArr);
        0FI.A09(482561318, A03);
    }
    ...
    public byte[] A03() {
        ...
        if (!(this instanceof zzl)) {
            int A032 = 0FI.A03(1582342837);
            byte[] bArr2 = ((zzk) this).A00;
            0FI.A09(451980932, A032);
            return bArr2;
        }
        zzl zzlVar = (zzl) this;
        int A033 = 0FI.A03(120663916);
        synchronized (zzlVar) {
            try {
                bArr = (byte[]) zzlVar.A00.get();
                if (bArr == null) {
                    if (zzlVar instanceof zzh) {
                        A03 = 0FI.A03(1614733454);
                        ...
                        i = 1413357588;
                    } else if (zzlVar instanceof zzi) {
                        A03 = 0FI.A03(-1006782509);
                        ...
                        i = 757928196;
                    } else if (zzlVar instanceof zzg) {
                        A03 = 0FI.A03(-393939712);
                    ...
                    0FI.A09(i, A03);
                    zzlVar.A00 = new WeakReference(bArr);
                }
            } catch (Throwable th) {
                0FI.A09(1959097286, A033);
                throw th;
            }
        }
        0FI.A09(-237813334, A033);
        return bArr;
    }

    public final boolean equals(Object obj) {
        int i;
        int A03 = 0FI.A03(1186965809);
        if (obj == null || !(obj instanceof zzaa)) {
            i = -370635717;
        } else {
            try {
                zzj zzjVar = (zzj) ((zzaa) obj);
                int A032 = 0FI.A03(-1059546480);
                int i2 = zzjVar.A00;
                0FI.A09(-959291342, A032);
                if (i2 == this.A00) {
                    int A033 = 0FI.A03(-1049053617);
                    ObjectWrapper objectWrapper = new ObjectWrapper(zzjVar.A03());
                    0FI.A09(694498148, A033);
                    boolean equals = Arrays.equals(A03(), (byte[]) objectWrapper.A00);
                    0FI.A09(-871447886, A03);
                    return equals;
                }
                i = -814620244;
            } catch (RemoteException e) {
                Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e);
                0FI.A09(-1550026125, A03);
                return false;
            }
        }
        0FI.A09(i, A03);
    ...
    public final int hashCode() {
        int A03 = 0FI.A03(455940741);
        int i = this.A00;
        0FI.A09(-1649393056, A03);
        return i;
    }
}
