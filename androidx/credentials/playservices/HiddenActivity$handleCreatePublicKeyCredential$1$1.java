...
/* loaded from: HiddenActivity$handleCreatePublicKeyCredential$1$1.class */
public final class HiddenActivity$handleCreatePublicKeyCredential$1$1 extends C00q implements Function1 {
    ...
    public final void invoke(PendingIntent pendingIntent) {
        ...
        try {
            ...
            hiddenActivity2.setupFailure(resultReceiver, CredentialProviderBaseController.CREATE_UNKNOWN, 0Pz.A1B("During public key credential, found IntentSender failure on public key creation: ", e));
        }
    }
}
