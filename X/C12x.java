...
public abstract class C12x {
    public static String A00(int i) {
        ...
        switch (i) {
            ...
            case 4735:
                return "WEARABLE_CONNECTIVITY_WCM_WARM_HBN_REQUEST";
            case 4895:
                return "WEARABLE_CONNECTIVITY_WEARABLE_MNS_HTTP_REQUEST";
            case 5074:
                return "WEARABLE_CONNECTIVITY_WIFI_SHARE";
            case 5127:
                return "WEARABLE_CONNECTIVITY_WCM_IMPLICIT_DUA_REQUEST";
            case 5511:
                return "WEARABLE_CONNECTIVITY_DATA_MANAGER_PING";
            case 5608:
                return "WEARABLE_CONNECTIVITY_HIGH_BANDWIDTH_TRANSFER";
            case 5867:
                return "WEARABLE_CONNECTIVITY_TIME_SYNC";
            case 6568:
                return "WEARABLE_CONNECTIVITY_TFTP_FILE_TRANFER";
            case 6615:
                return "WEARABLE_CONNECTIVITY_BT_RECONNECTION";
            case 6804:
                return "WEARABLE_CONNECTIVITY_BT_PROXY_ENABLED";
            case 7403:
                return "WEARABLE_CONNECTIVITY_LINK_SWITCH";
            case 7831:
                return "WEARABLE_CONNECTIVITY_BT_PROXY_SESSION";
            case 8317:
                return "WEARABLE_CONNECTIVITY_WCM_NETWORK_CONNECTED";
            case 9019:
                return "WEARABLE_CONNECTIVITY_CONNECT_TO_REMOTE_SERVICE_SUSPEND";
            case 9315:
                return "WEARABLE_CONNECTIVITY_BT_PROXY_VALIDATION_SESSION";
            case 10122:
                return "WEARABLE_CONNECTIVITY_WCM_CONNECTION_BOOT";
            case 10273:
                return "WEARABLE_CONNECTIVITY_WCM_NETWORK_ENABLED";
            case 12216:
