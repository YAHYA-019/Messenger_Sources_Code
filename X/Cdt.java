...
/* loaded from: Cdt.class */
public final class Cdt implements DIM {
    ...
    public Cdt(Context context, 06Z r303, FbUserSession fbUserSession, ThreadKey threadKey, ThreadSummary threadSummary, DJX djx, DHb dHb, DHc dHc, DHd dHd, MigColorScheme migColorScheme, User user, Capabilities capabilities, 2Sh r314, C1783AsH c1783AsH, ImmutableList immutableList) {
        this.A06 = context;
            ...
            try {
                try {
                    if (AbL.A1N(r0, atomicInteger)) {
                        Capabilities capabilities = this.A0I;
                        User user = this.A0H;
                        if (BXH.A00(user, capabilities, this.A0J)) {
                    ...
                    th = th;
                    r0.A03(exc, "messaging.wellbeing.selfremediation.block.threadsettingsrow.blockuser.ThreadSettingsBlockUserRow", A18, andIncrement, 1BL.A1U(this.A04));
                    throw th;
                }
            } catch (Exception e) {
                this.A04 = C1Y6.A03;
