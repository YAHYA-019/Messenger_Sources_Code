...
/* loaded from: Cr1.class */
public final class Cr1 implements DJ0 {
    public final DIn A00;

    public Cr1(Be0 be0) {
        this.A00 = new Cs3(be0, 1);
    }
    ...
    @Override // X.DJ0
    public void CJW(BP5 bp5, DK4 dk4, AcX acX, int i, int i2, int i3, int i4, int i5) {
        if (acX != null) {
            acX.A08(this.A00);
        }
    }
