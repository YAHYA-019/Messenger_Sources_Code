...
/* loaded from: Cca.class */
public final class Cca implements DIK {
    public 20L A01;
    ...
    public Cca(Context context, LifecycleOwner lifecycleOwner, DFp dFp) {
        this.A0A = context;
    ...
    */
    private boolean A01() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.Cca.A01():boolean");
    }
    ...
    */
    private boolean A02() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: X.Cca.A02():boolean");
    }
    ...
    */
    private boolean A03() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: X.Cca.A03():boolean");
    }
        ...
        try {
            ...
            try {
                ...
                if (A02()) {
                    ...
                    r0.A0A("com.facebook.messaging.advancedcrypto.plugins.core.privacysettings.securityalerts.PrivacySettingsSecurityAlertsRow", "messaging.advancedcrypto.core.privacysettings.securityalerts.PrivacySettingsSecurityAlertsRow", "com.facebook.messaging.messengerprefs.plugins.interfaces.privacysettings.settingitems.PrivacySettingsItemInterfaceSpec", andIncrement2, "messaging.messengerprefs.privacysettings.settingitems.PrivacySettingsItemInterfaceSpec", "com.facebook.messaging.advancedcrypto.plugins.core.ArmadilloCoreKillSwitch", "createPrivacySettingsRowItem");
                    AbJ.A1I(r302, this.A03.A00(), A0t);
                    r0.A09("messaging.advancedcrypto.core.privacysettings.securityalerts.PrivacySettingsSecurityAlertsRow", "messaging.messengerprefs.privacysettings.settingitems.PrivacySettingsItemInterfaceSpec", "createPrivacySettingsRowItem", andIncrement2);
                }
                if (A03()) {
                    i = atomicInteger.getAndIncrement();
                    str = "messaging.encryptedbackups.privacysettings.PrivacySettingEncryptedBackups";
                    r0.A0A("com.facebook.messaging.encryptedbackups.plugins.privacysettings.PrivacySettingEncryptedBackups", str, "com.facebook.messaging.messengerprefs.plugins.interfaces.privacysettings.settingitems.PrivacySettingsItemInterfaceSpec", i, "messaging.messengerprefs.privacysettings.settingitems.PrivacySettingsItemInterfaceSpec", "com.facebook.messaging.encryptedbackups.plugins.EncryptedBackupsKillSwitch", "createPrivacySettingsRowItem");
