...
/* loaded from: Lnm.class */
public final class Lnm implements Runnable {
    ...
    public Lnm(DefaultChoreographerWrapper_API16 defaultChoreographerWrapper_API16, C1pl c1pl) {
    ...
    public void run() {
        ...
        choreographer.postFrameCallbackDelayed(this.A01.A02(), 400L);
    }
}
